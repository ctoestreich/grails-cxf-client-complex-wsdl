...
public class DigitalSignatureService extends Service {
    ...
    static {
        URL url = DigitalSignatureService.class.getResource("dss.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(DigitalSignatureService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "dss.wsdl");
        }       
        WSDL_LOCATION = url;
    }
